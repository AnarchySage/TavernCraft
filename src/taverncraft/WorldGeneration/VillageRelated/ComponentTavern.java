...
public class ComponentTavern extends ComponentVillage
{
    private int averageGroundLevel = -1;
    private final boolean isRoofAccessible;

    public ComponentTavern(ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public static ComponentTavern func_74912_a (ComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        return StructureComponent.findIntersecting(par1List, structureboundingbox) != null ? null : new ComponentTavern(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox,
                par6);
    }
