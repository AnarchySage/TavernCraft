...
import taverncraft.WorldGeneration.Tavern.TavernSpawnGen;
...
public class TavernSpawn extends Item {
    ...
    {
        return new TavernSpawnGen().generate(par3World, null, i, j, k);
    ...
    public void registerIcons (IconRegister iconRegister)
    {
        ...
        {
            this.icons[i] = iconRegister.registerIcon("mixology:");
        }
    }
}
