...
public class BlockVineGrapeRender implements ISimpleBlockRenderingHandler
{
    public static int vinegrapeModelID = RenderingRegistry.getNextAvailableRenderId();

    @Override
    public void renderInventoryBlock (Block block, int metadata, int modelID, RenderBlocks renderer)
    {
        if (modelID == vinegrapeModelID)
        {
            if (metadata == 0)
            {
                // Bar rod east-west
