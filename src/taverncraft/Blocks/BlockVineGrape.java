...
import taverncraft.Renders.BlockVineGrapeRender;
...
public class BlockVineGrape extends BlockDirectional {
    
    
    @SideOnly(Side.CLIENT)
    private Icon[] iconArray;

    public BlockVineGrape(int par1)
    {
    ...
    @SideOnly(Side.CLIENT)
    public Icon getGrapeIcon(int par1)
    {
    ...
    public boolean canBlockStay(World par1World, int par2, int par3, int par4)
    {
        ...
        return i1 == BlockRegistrations.trellisblock.blockID; //&& BlockTrellis.limitToValidMetadata(par1World.getBlockMetadata(par2, par3, par4)) == 3;
    }
    ...
    {
        return BlockVineGrapeRender.vinegrapeModelID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.iconArray[i] = par1IconRegister.registerIcon("taverncraft:Vine.Grape_stage_" + i);
        }
    }
